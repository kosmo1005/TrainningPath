...
public class Protection_pro {
    Protection_pro i = new Protection_pro();
    // Объявляю внутренний класс protected
    protected class Protections_pro1 {
        Protections_pro1 ivi = new Protections_pro1();
        int n = 1;
        private int n_pri = 2;
